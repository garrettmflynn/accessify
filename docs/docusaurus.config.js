...
const config = {
  title: 'Accessify',
  tagline: 'Web accessibility for low-bandwidth inputs',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/brainsatplay/accessify',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/brainsatplay/accessify',
            // label: 'GitHub',
            position: 'right',
            ...
            items: [
              {
                ...
                href: 'https://stackoverflow.com/questions/tagged/accessify',
              },
              {
                label: 'Discord',
