...
export class Keyboard extends LitElement {
  ...
  static get styles() {
    ...
    target: KeyboardProps['target']
    header: KeyboardProps['header']
    history: any[] = []
    mode: string

    constructor(props: KeyboardProps = {target: {}, header: 'Object'}) {
      super();
  ...
  customElements.define('accessify-keyboard', Keyboard);