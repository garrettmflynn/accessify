...
export class Mouse extends LitElement {
  ...
  static get styles() {
    ...
    target: MouseProps['target']
    header: MouseProps['header']
    history: any[] = []
    mode: string

    constructor(props: MouseProps = {target: {}, header: 'Object'}) {
      super();
  ...
  customElements.define('accessify-mouse', Mouse);